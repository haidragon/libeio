...
# 检查基本系统头文件
ls /usr/include/sys/ | grep -E "(types|stat)" | head -5
```
...
# 第四步：编译示例程序
gcc -I. -O2 -g demo.c -L. -leio -lpthread -o demo
gcc -I. -O2 -g eio_simple_example.c -L. -leio -lpthread -o eio_simple_example
```
...
# macOS系统配置
./configure CFLAGS="-O2 -D_DARWIN_C_SOURCE"
...
```bash
# 系统头文件缺失
# 错误信息：sys/xxx.h: No such file or directory
...
# 解决方案：确保正确的链接顺序
gcc demo.c etp.o eio.o -lpthread -o demo  # etp.o要在eio.o之前
```
